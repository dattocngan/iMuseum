    ...
    return (
        <form className={`row g-3 needs-validation ${
            ...
            <div className="col-md-4">
                ...
                <input ref={nameInputRef} type="text" className="form-control" id="name" required />
            ...
            <div className="col-md-4">
                ...
                <input ref={originalInputRef} type="text" className="form-control" id="original" />
            </div>
            <div className="col-md-4">
                <label htmlFor="dimension" className="form-label">Kích thước:</label>
                <input ref={dimensionInputRef} type="text" className="form-control" id="dimension" />
            </div>
            <div className="col-md-3">
                <label htmlFor="weight" className="form-label">Cân nặng (kg):</label>
                <input ref={weightInputRef} step="0.01" type="number" className="form-control" id="weight" />
            </div>
            <div className="col-md-3">
                <label htmlFor="material" className="form-label">Niên đại</label>
                <select ref={ageInputRef} className="form-select" id="material" defaultValue={''} required>
            ...
            <div className="col-md-3">
                <label htmlFor="age" className="form-label">Nguyên liệu</label>
                <select ref={materialInputRef} className="form-select" id="age" defaultValue={''} required>
            ...
            <div className="col-md-3">
                ...
                <input ref={dateInputRef} type="date" className="form-control" id="date" />
            </div>
            <div className="col-md-6">
                <label htmlFor="feature_image" className="form-label">Ảnh đại diện hiện vật:</label>
                <input ref={featureImageInputRef} className="form-control" type="file" id="feature_image" required />
                <div className="invalid-feedback">
            ...
            <div className="col-12">
                ...
                <textarea ref={descriptionInputRef} className="form-control" id="description" rows="7"></textarea>
            </div>
            <div className="col-12">
