    ...
    <>
      ...
      <form className={`row g-3 needs-validation ${
        ...
        <div className="col-md-3">
          ...
          <select ref={ageInputRef} className="form-select" id="age" defaultValue={''} required>
        ...
        <div className="col-md-3">
          ...
          <select ref={materialInputRef} className="form-select" id="material" defaultValue={''} required>
        ...
        <div className="col-md-3">
          ...
          <input ref={dateInputRef} type="date" className="form-control" id="date" defaultValue="2015-12-31"/>
        </div>
