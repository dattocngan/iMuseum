...
function AllCollections() {
    ...
    return (
        <>
            <button className="btn btn-success mb-3"><Link to='/admin/collections/add' style={{ color: '#FFF' }}>Thêm bộ sưu tập mới</Link></button>
                ...
                <table className="table table-hover table-bordered bg-white text-center">
                    ...
                    {collections.map((collection) =>
                        <tr key={collectionOffset}>
                            ...
                            <td className="align-middle"><button className="btn btn-danger" disabled={collection.status}>Xóa</button></td>
                        </tr>
                    )}
                    </tbody>
                </table>
