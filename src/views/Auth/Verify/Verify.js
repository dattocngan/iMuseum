        ...
        <article className="card-body">
          ...
          <form onSubmit={submitFormHandler}>
            ...
            <div className="form-group d-flex">
              <button disabled={refreshOTP} type="button" className="btn btn-success btn-block w-50"
                      onClick={refreshOTPHandler}>Gửi lại mã
              </button>
              {refreshOTP && <Countdown date={Date.parse(refreshTime) + 1000 * 60 * 3} onComplete={completeHandler}
                                        renderer={renderer}/>}
            </div>
